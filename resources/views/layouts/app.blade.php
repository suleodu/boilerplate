    ...
    <ul class="nav pmd-sidebar-nav">
        ...
        <li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
            <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
                <div class="media-left">
                    <img height="30" width="20" src="{{(Auth::user()->image_url) ? asset('assets/images/users/'.Auth::user()->image_url) : asset('themes/images/user-icon.png')}} " alt="New User">
                </div>
        ...
        <li> 
            <a class="pmd-ripple-effect" href="{{route('home')}}">	
        ...
        $modules = App\Module::whereName($module_name)->whereStatus('active')->get();
        @endphp
        @foreach($modules as $module)
        <li class="dropdown pmd-dropdown"> 
            <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">	
                <i class="material-icons media-left pmd-sm">{{$module->icon}}</i> 
                <span class="media-body">{{$module->display_name}}</span>
                <div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
            </a> 
            <ul class="dropdown-menu">
                @foreach($module->module_links->where('status', 'active') as $link)
                <li><a class="pmd-ripple-effect" href="{{route($link->url)}}">{{$link->name}}</a></li>
                @endforeach
            </ul>
        </li>
        @endforeach
